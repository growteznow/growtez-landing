  ...
  return (
    <footer style={{ borderTop: "1px solid rgba(0,0,0,0.05)", background: PAGE_BG, padding: "56px 40px" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div style={{ marginTop: 24, display: "flex", gap: 12 }}>
              {[
                ...
                <a key={i} href={item.href} style={{ width: 36, height: 36, borderRadius: 8, border: "1px solid rgba(0,0,0,0.1)", display: "flex", alignItems: "center", justifyContent: "center", color: SLATE_500, textDecoration: "none", transition: "color 0.2s, border-color 0.2s" }}
          ...
          {[
            ...
            <div key={col.heading}>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 10 }}>
                {col.links.map(l => (
                  <li key={l.label}>
                    <Link href={l.href} style={{ fontSize: "0.875rem", color: SLATE_500, textDecoration: "none", transition: "color 0.2s" }}
        ...
        <div style={{ borderTop: "1px solid rgba(0,0,0,0.05)", paddingTop: 28, display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "space-between", alignItems: "center", fontSize: "0.85rem", color: SLATE_400 }}>
